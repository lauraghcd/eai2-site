...
categories: ["Industry"]
summary: "A comprehensive overview of China's rapidly growing humanoid robot ecosystem — key players, funding, production volumes, and technology approaches."
ShowToc: true
TocOpen: true
---
...
**Focus:** Rehabilitation and healthcare humanoids
**GR-2:** Deployed in hospitals and rehabilitation centers
**Key advantage:** Clear niche (medical) with less competition than factory automation

### Galbot (加尔伯特)

**Focus:** Warehouse and logistics humanoids
**Funding:** Over $100M raised in 2025-2026
**Key advantage:** Backed by logistics industry investors, direct access to deployment sites

### Agilex Robotics (松灵机器人)

**Focus:** Mobile manipulation platforms
**Key advantage:** Strong in AGV/AMR market, expanding to humanoid form factor
...
1. **AgiBot IPO:** Widely expected in 2026-2027. Would be the first humanoid-focused IPO globally.
2. **Price war escalation:** As more companies reach production, expect aggressive pricing that may consolidate the market.
3. **Export expansion:** Chinese humanoid robots are starting to appear in Southeast Asian and Middle Eastern markets.
4. **VLA model development:** China's domestic VLA models (trained on Chinese factory data) may diverge from Western approaches.
